...
class InfrastructureCostTracker:
    ...
    def get_cost_by_type(self) -> dict[str, float]:
        ...
        for cost in self.costs:
            ...
            breakdown[resource_type] = breakdown.get(resource_type, 0.0) + cost.cost_usd
        return breakdown
    ...
    def get_daily_cost(self, date: datetime | None = None) -> float:
        ...
        daily_costs = [c for c in self.costs if start_of_day <= c.timestamp < end_of_day]
...
_infrastructure_cost_tracker: InfrastructureCostTracker | None = None
